...
N must be an integerer that is greater than or equal to 4.

Attributes:
    board (list): A list of lists representing the chessboard.
    solutions (list): A list of lists containing solutions.

Solutions are in the format [[r, c], [r, c], [r, c], [r, c]]
...
def xout(board, row, col):
    ...
    The placesin which  non-attacking queens can no
    longer be played are removed.
